...
Imagine you try ten different ways to solve a problem. You only need **one** of them to work!
...
<div class="references-section">
  <h3>Stories Worth Watching</h3>
  <p>If you need a reminder that failure is just data collection, check out these real-life examples:</p>
  <ul>
    <li><strong><a href="https://www.youtube.com/watch?v=9vJRopau0g0" target="_blank">The Super Mario Effect</a>:</strong> Former NASA engineer Mark Rober explains how reframing failure like a video game (where you just try again without penalty) dramatically increases your success rate.</li>
    <li><strong><a href="https://www.youtube.com/watch?v=bvim4rsNHkQ" target="_blank">SpaceX's Rocket Landing Bloopers</a>:</strong> A spectacular, multi-million dollar blooper reel of exploding rockets, proving that even the most advanced engineering requires dozens of spectacular failures to get it right.</li>
    <li><strong><a href="https://www.youtube.com/watch?v=tiIyMMGoP8g" target="_blank">James Dyson's 5,126 Failures</a>:</strong> Before creating the revolutionary Dyson vacuum, James Dyson spent years building exactly 5,126 failed prototypes. Prototype 5,127 was the one that changed the world. :)</li>
  </ul>
</div>
